...
class VendorSignUp : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        vendorSignUpBinding.uploadBtn.setOnClickListener {
        ...
        vendorSignUpBinding.vendorSignBtn.setOnClickListener {
            ...
            val password = vendorSignUpBinding.vendorPass.text.toString().trim()
    ...
    private fun registerActivityForResult() {
        activityResultLauncher = registerForActivityResult(
            ...
            ActivityResultCallback { result ->
                ...
                val greenColor = ContextCompat.getColor(vendorSignUpBinding.root.context, R.color.green)
                if (resultCode == RESULT_OK && imageData != null) {
                    imageUri = imageData.data
                    imageUri?.let {
                        Picasso.get().load(it).into(vendorSignUpBinding.uploadBtn)
                        vendorSignUpBinding.textView13.setTextColor(greenColor)
    ...
    private fun uploadPhotoAndCreateVendor(email: String, password: String, panno: String, shopName: String) {
        vendorSignUpBinding.vendorSignBtn.isEnabled = false
        ...
        imageUri?.let { url ->
            imageReference.putFile(url).addOnSuccessListener {
                ...
                vendorSignUpBinding.vendorSignBtn.isEnabled = true
